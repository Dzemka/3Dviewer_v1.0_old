...
int main(int argc, char **argv, char **env) {
  ...
  result = parser("tests_data/test7_file.obj", viewer);
  if (result == 1) printf("Parser Tets7: OK\n");
  else printf("Parser Tets7: NO\n");
  clean_info(viewer);

  //хороший файл
  result = parser("tests_data/test8_file.obj", viewer);
